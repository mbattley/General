...
confirmed_data['pmra_1'].unit = 'mas/yr'
confirmed_data['pmdec_1'].unit = 'mas/yr'
confirmed_data['ra_1'].unit = 'deg'
confirmed_data['dec_1'].unit = 'deg'
...
c_icrs_hipparcos = SkyCoord(ra = confirmed_data['ra_1'], dec = confirmed_data['dec_1'], pm_ra_cosdec = confirmed_data['pmra_1'], pm_dec = confirmed_data['pmdec_1'])
...
false_dist_indices = [i for i, x in enumerate(data['rest']) if x >210 or x < 60 ]
...
plt.title('Proper motion plot for area around Sco-OB2 members')
...
plt.title('Proper motion plot for area around Sco-OB2')
plt.scatter(confirmed_data['pmra_1'],confirmed_data['pmdec_1'], 0.1, 'k')
...
plt.title('Colour-Absolute Magnitude Density Plot for stars in the vicinity of Sco-OB2')
...
plt.xlabel('pm_l_cosb (mas/yr)')
plt.ylabel('pm_b (mas/yr)')
plt.title('Proper motion plot for potential Sco-OB2 members')
plt.scatter(confirmed_data['pm_l_cosb'],confirmed_data['pm_b'], 0.1, 'k')
