...
def print_spectral_types(spectral_type):
    ...
    for i, x in enumerate(spectral_type):
        if spectral_type[i] == '':
            pass
        elif 'O' in spectral_type[i]:
            O += 1
        elif 'B' in spectral_type[i]:
            B += 1
        elif 'A' in spectral_type[i]:
            A += 1
        elif 'F' in spectral_type[i]:
            F += 1
        elif 'G' in spectral_type[i]:
            G += 1
        elif 'K' in spectral_type[i]:
            K += 1
