...
#        plt.close(ls_fig)
        ...
        freq_rot = freq[i]
        p_rot = 1/freq_rot
        t0_to_test = lc_30min.time[0]
        print('Rotation Period = {:.3f}d'.format(p_rot))
        phase_fold_plot(lc_30min.time, normalized_flux, p_rot, t0_to_test, target_ID, save_path, '{} original lc folded by rotation period ({:0.4} days)'.format(target_ID,p_rot))
#        
#        # From BLS
...
save_path = '/Users/mbattley/Documents/PhD/New detrending methods/Smoothing/lowess/QLP lcs/' # On laptop
sector = 1
pipeline = 'QLP'
...
directory_str = '/Users/mbattley/Documents/PhD/Python/QLP lcs'
...
#         print(filename)
#         print(filename[58],filename[59],filename[60])
#         if filename[58] == '1':
#             print("Yeeheheheaaaaah bwoi")
         continue
     else:
         continue
end = time.time()
